...
from modules.chatbot import response_generator, show_msgs, chat_with_ollama
...
def main():
    ...
    if prompt:
        ...
        response = openai.ChatCompletion.create(model="gpt-3.5-turbo-0125",messages=messages_for_api)
